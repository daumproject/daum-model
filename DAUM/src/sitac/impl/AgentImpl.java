 ...
 * <ul>
 *   <li>{@link sitac.impl.AgentImpl#getMatricule <em>Matricule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AgentImpl extends PersonneImpl implements Agent {
	/**
	...
	protected EClass eStaticClass() {
		return SitacPackage.Literals.AGENT;
	}
	...
	public void setMatricule(String newMatricule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitacPackage.AGENT__MATRICULE, oldMatricule, matricule));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitacPackage.AGENT__MATRICULE:
				return getMatricule();
		}
