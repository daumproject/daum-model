 ...
 * <ul>
 *   <li>{@link sitac.impl.PersonneImpl#getNom <em>Nom</em>}</li>
 *   <li>{@link sitac.impl.PersonneImpl#getPrenom <em>Prenom</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PersonneImpl extends EObjectImpl implements Personne {
	...
	protected EClass eStaticClass() {
		return SitacPackage.Literals.PERSONNE;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitacPackage.PERSONNE__NOM, oldNom, nom));
	}
	...
	public void setPrenom(String newPrenom) {
		...
		prenom = newPrenom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitacPackage.PERSONNE__PRENOM, oldPrenom, prenom));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitacPackage.PERSONNE__NOM:
				return getNom();
			case SitacPackage.PERSONNE__PRENOM:
				return getPrenom();
		}
